...
const Game = {
  ...
  adaptText(originalText) {
    ...
    if (this.readingLevel === 'beginner') {
      const B = {
        ...
        'The truth comes out! ⚖️': 'I knew it! ⚖️',
        'Suspicious... 👀': 'Hmm! 👀',
        'Hmm... 🧐': 'Hmm! 🧐',
        'Hmm... suspicious! 🤨': 'Hmm! 🤨',
        'Hmm, suspicious... 🤔': 'Hmm! 🤔',
        ...
        'Make an accusation! ⚖️': 'Who did it? ⚖️',
        'Thanks Bunny! 👍': 'Thanks! 👍',
        "Thanks Cat! 😸": 'Thanks! 😸',
        'Thanks Dog! 🐕': 'Thanks! 🐕',
        'Thanks Mouse! 🐭': 'Thanks! 🐭',
        ...
        'Bunny was digging here! Looking for a place to hide the ball! 🕳️': 'Digging marks here! 🕳️',
        ...
        'The ball buried in the sand! Dog hid it here! 🏖️⚽': 'Ball in the sand! 🏖️⚽',
        ...
        'The couch looks normal. Is the present under the cushions?': 'Look under the couch! 🛋️',
  ...
  collectClue(clue) {
    ...
    this.showDialogue('🔍 Clue Found!', `${adaptedDesc} ${adaptedProgress}`, [
      { text: remainingClues === 0 ? 'Make an accusation! ⚖️' : 'Add to notebook! 📓', action: remainingClues === 0 ? 'accuse' : 'close' }
    ], true);
